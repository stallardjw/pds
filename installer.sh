...
COMPOSE_URL="https://raw.githubusercontent.com/stallardjw/pds/main/compose.yaml"

# The pdsadmin script.
PDSADMIN_URL="https://raw.githubusercontent.com/stallardjw/pds/main/pdsadmin.sh"
...
function main {
  ...
  if [[ -e "${PDS_DATADIR}/pds.sqlite" ]]; then
    ...
    echo "  sudo bash ${0}"
    echo
    echo "For assistance, check https://github.com/stallardjw/pds"
    exit 1
  fi
...
Documentation=https://github.com/stallardjw/pds
